  ...
  <div class="row g-3">
    ...
    v.correlativo = $id_vehiculo";
      ...
      ?>
        ...
        <strong class="badge bg-success text-wrap" style="width: 8rem; height: 3rem; font-size: 17px;">Tracción: </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="badge bg-primary text-wrap" style="width: 8rem; height: 2rem; font-size: 17px;"><?php echo $traccion ?></strong><br><br>
        ...
        <strong class="badge bg-success text-wrap" style="width: 8rem; height: 2rem; font-size: 17px;">Precio: </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong class="badge bg-primary text-wrap" style="width: 8rem; height: 2rem; font-size: 17px;"><?php echo $precio ?></strong><br><br>   
  
        <div class="col-md-12">
        <div class="badge bg-success text-wrap" style="width: 8rem; height: 2rem; font-size: 17px;">
          Marca
        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="badge bg-primary text-wrap" style="width: 8rem; height: 2rem; font-size: 17px;">
          <?php echo $marca ?>
        </div>
        </div>
