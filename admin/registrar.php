...
<body>
	<div class="auxLogin">
		...
		<div class="lateralDerecho">
			...
			<form style="width: 100%" action="RegistrarUsuario.php" method="POST">
				...
				<div class="auxCampos">
					...
					<div class="auxDetampos">
						<input class="camposIngreso" type="text" name="nombreColaborador" placeholder="Nombre Colaborador..." required>

						<input class="camposIngreso" type="text" name="us_colaborador" placeholder="Usuario..." required>

						<input class="camposIngreso" type="password" name="us_contra" placeholder="Contraseña..." required>
